...
const HEADLINE_LINES = ['Pay for care,', 'over time.'] as const
const SUBTEXT =
  'Premium, Sharia-compliant financing for the treatment you need today — spread the cost into simple monthly payments.'
const TRUST_LABEL = 'Sharia-compliant · 0% plans available'
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-brand-navy">
      ...
      <Image
        ...
        alt="A clinician and patient in a calm, modern consultation room"
        fill
        priority
        sizes="100vw"
        ...
        <div className="max-w-2xl text-white">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-x-7 gap-y-3 text-[13px] text-white/80">
            ...
            <span className="inline-flex items-center gap-2 font-medium text-white/80">
              ...
              No impact on your credit to check
            </span>
          </div>
        </div>
      </div>
