...
const CTA = {
  heading: 'Care shouldn’t wait.',
  subtext: 'Check your rate in minutes — with no impact on your credit and nothing to pay today.',
  primary: { label: 'Check your rate', href: '/apply' },
  image: {
    src: 'https://images.unsplash.com/photo-1666214280557-f1b5022eb634?auto=format&fit=crop&w=1920&q=80',
    alt: 'A patient smiling with their doctor after good news',
  },
} as const
    ...
    >
      ...
      <div className="container-width relative flex min-h-[60vh] lg:min-h-[70vh] items-end">
        <div className="max-w-xl pb-14 lg:pb-20">
          ...
          <p className="mt-5 max-w-md text-[17px] leading-relaxed text-white/85">{CTA.subtext}</p>
